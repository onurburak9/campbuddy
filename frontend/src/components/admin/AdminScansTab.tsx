...
export function AdminScansTab() {
  ...
  return (
    <>
      {(pause.isError || resume.isError || del.isError) && (
        <p className="border-b border-red-200 bg-red-50 px-4 py-2 text-sm text-red-700 dark:border-red-900/40 dark:bg-red-900/20 dark:text-red-400">
