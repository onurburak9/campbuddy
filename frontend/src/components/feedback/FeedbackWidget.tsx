...
export function FeedbackWidget({ className = "flex h-8 w-8" }: { className?: string }) {
  ...
  return (
    <>
      <button
        ...
        className={cn(
          "items-center justify-center rounded-md text-campfire-600 transition-colors hover:bg-campfire-50 dark:text-campfire-300 dark:hover:bg-campfire-900/40",
          className
        )}
      >
